...
if(WITH_EXAMPLES)
  ...
  add_example(qpt_fidelity SOURCES ${CMAKE_CURRENT_SOURCE_DIR}/examples/cpp/qpt_fidelity/qpt_fidelity_example.cpp)
  add_example(qpt SOURCES ${CMAKE_CURRENT_SOURCE_DIR}/examples/cpp/qpt/qpt_example.cpp)
  add_example(pyGSTi_runner SOURCES ${CMAKE_CURRENT_SOURCE_DIR}/examples/cpp/pyGSTi_runner/pyGSTi_runner.cpp)
