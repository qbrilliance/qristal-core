...
PYBIND11_MAKE_OPAQUE(qristal::noise_aware_placement_config::device_topology_t);
PYBIND11_MAKE_OPAQUE(qristal::noise_aware_placement_config::single_qubit_gate_errors_t);
PYBIND11_MAKE_OPAQUE(qristal::noise_aware_placement_config::two_qubit_gate_errors_t);
