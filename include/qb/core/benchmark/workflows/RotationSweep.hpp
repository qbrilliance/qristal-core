...
#ifndef _QB_BENCHMARK_ROTATIONSWEEP_
#define _QB_BENCHMARK_ROTATIONSWEEP_
        ...
        */
        ...
        { 
            public:
                ...
                */
                std::vector<qb::CircuitBuilder> get_circuits() const; //return full list of RotationSweep circuits (no measurements!)
                /**
