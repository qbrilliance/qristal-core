...
def test_qaoa_simple() :
    ...
    assert qa.out_eigenstate[0][0] == "001", "[qbos_op.qaoa()] Failed eigenstate test: qaoa_simple_expect_001"
    assert qa.out_eigenstate[0][1] == "000", "[qbos_op.qaoa()] Failed eigenstate test: qaoa_simple_expect_000"
...
def test_qaoa_simple_kite() :
    ...
    assert qa.out_eigenstate[0][0] == "10100" or qa.out_eigenstate[0][0] == "01011", "[qbos_op.QaoaSimple()] Failed eigenstate test: qaoa_simple_kite"
    print("test_qaoa_simple passed")
...
def test_qaoa_recursive_kite() :
    ...
    assert qa.out_eigenstate[0][0] == "10100" or qa.out_eigenstate[0][0] == "01011", "[qbos_op.QaoaRecursive()] Failed eigenstate test: CI_220711_rqaoa_kite"
...
def test_qaoa_warm_start_kite() :
    ...
    assert qa.out_eigenstate[0][0] == "01011", "[qbos_op.QaoaWarmStart()] Failed eigenstate test: qaoa_warm_start_kite"
