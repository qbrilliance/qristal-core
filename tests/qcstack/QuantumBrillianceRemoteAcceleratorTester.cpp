...
TEST(QuantumBrillianceRemoteAcceleratorTester, testInstantiationGetDetailsPre_v1) {
  int shots = 256;
  int n_qubits = 4;
  ...
  mm.insert("remote_url", std::string("https://myuser23:myPass*23@8dd1-3-26-179-186.au.ngrok.io/"));
...
TEST(QuantumBrillianceRemoteAcceleratorTester, testInstantiationGetDetails_v1) {
  int shots = 256;
  int n_qubits = 4;
  std::vector<int> init_qubits(n_qubits, 0);
